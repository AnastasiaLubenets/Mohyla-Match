...
export default async function AccountSuspendedPage() {
  await requireAccountState("/account/suspended", ["suspended"]);
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5 py-10">
      <section className="w-full max-w-lg rounded-lg border border-border bg-surface p-6 shadow-sm">
        ...
        <h1 className="mt-8 text-3xl font-semibold">Account suspended</h1>
        <p className="mt-3 leading-7 text-muted">
          Access to Mohyla Match is paused for this account.
        </p>
